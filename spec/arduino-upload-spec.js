...
(function() {
  ...
  describe("ArduinoUpload", function() {
    var activationPromise, workspaceElement;
    [workspaceElement, activationPromise] = [];
    beforeEach(function() {
      workspaceElement = atom.views.getView(atom.workspace);
      return activationPromise = atom.packages.activatePackage('arduino-upload');
    });
    return describe("when the arduino-upload:toggle event is triggered", function() {
      it("hides and shows the modal panel", function() {
        ...
        return runs(function() {
          var arduinoUploadElement, arduinoUploadPanel;
          ...
          atom.commands.dispatch(workspaceElement, 'arduino-upload:toggle');
          return expect(arduinoUploadPanel.isVisible()).toBe(false);
        });
      });
      return it("hides and shows the view", function() {
        ...
        return runs(function() {
          var arduinoUploadElement;
          // Now we can test for view visibility
          arduinoUploadElement = workspaceElement.querySelector('.arduino-upload');
          expect(arduinoUploadElement).toBeVisible();
          atom.commands.dispatch(workspaceElement, 'arduino-upload:toggle');
          return expect(arduinoUploadElement).not.toBeVisible();
        });
      });
    });
  });
